...
'''
    ...
    write(Path('.well-known/oauth-authorization-server'),json.dumps({'issuer':domain,'authorization_endpoint':domain+'/agent-auth/authorize','token_endpoint':domain+'/agent-auth/token','jwks_uri':domain+'/.well-known/jwks.json','response_types_supported':['code'],'grant_types_supported':['authorization_code'],'agent_auth':{'skill':domain+'/auth.md','register_uri':domain+'/agent-auth/register','identity_types_supported':['anonymous'],'anonymous':{'credential_types_supported':['planned_contract_only'],'claim_uri':domain+'/agent-auth/claim'},'revocation_uri':domain+'/agent-auth/revoke','methods':[{'type':'anonymous','credential_type':'planned_contract_only','available':False,'description':'Construction placeholder: registration is not available.'}]},**construction},separators=(',',':')))
